...
def seed():
    ...
    dir_ab1_main_middle = Direction(step = 2, message = 'If you\'re in the middle of the main floor, walk towards the entrance or walk towards the <strong>Auditorium</strong>').put()
